...
- **Normogravity conditions:**
    - `cluster1_analysis.csv` – First normogravity compression window  
    - `cluster2_analysis.csv` – Second normogravity compression window  

- **Hypogravity conditions:**
    - `parabola{i}_analysis.csv` – Flight 1 (5 cm compressions)  
    - `4cm_parabola{i}_analysis.csv` – Flight 2 (4 cm compressions)  
    - `5cm_parabola{i}_analysis.csv` – Flight 2 (5 cm compressions)  

- **Aggregated summaries:**
    - `4cm_flight_analysis.csv` – Per-parabola summaries for 4 cm hypogravity compressions  
    - `5cm_flight_analysis.csv` – Per-parabola summaries for 5 cm hypogravity compressions  
    - `CRISiS_analysis.csv` – Final merged dataset (Earth vs. hypogravity; 4 cm vs. 5 cm) used for statistical analysis and figure generation in the manuscript
...
For scientific or methodological questions regarding the CPR simulator or study design, please contact the corresponding author listed in the manuscript.

---

## Citing CPR-Simulator-Hypogravity

If you use this code or the associated CPR hypogravity methodology in your research, please cite the manuscript (details to be updated upon publication) and include a link to this repository.
